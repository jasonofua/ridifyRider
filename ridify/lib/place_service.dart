...
class PlaceService {
  static Future<List<PlaceItemRes>> searchPlace(String keyword) async {
    String url =
        "https://maps.googleapis.com/maps/api/place/textsearch/json?key=AIzaSyDQfIpM2KtOjLegQ65vxJPeHGNtIVY4qCA&language=vi&region=VN&query=" +
  ...
  static Future<dynamic> getStep(
    ...
    String url = "https://maps.googleapis.com/maps/api/directions/" +
        ...
        "?" +
        parameters +
        "&key=AIzaSyDQfIpM2KtOjLegQ65vxJPeHGNtIVY4qCA";
